...
btnLanzar1=Button(framePrincipal,text="LANZAR",command=valorDado(0),bg="black",fg="white",font=("Arial", 12))
lblDadoJugador2=Label(framePrincipal,image=imagenes[0])
btnLanzar2=Button(framePrincipal,text="LANZAR",command=valorDado(1),bg="black",fg="white",font=("Arial", 12))
